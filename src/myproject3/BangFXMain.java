...
public class BangFXMain extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        p4 = new Button(" 4 ");
        p4.setOnAction((e -> {
            MyProject3 game = new MyProject3(4);
        ...
        p5 = new Button(" 5 ");
        p5.setOnAction((e -> {
            MyProject3 game = new MyProject3(5);
            this.players = game.getPlayers();
            disable();
            nextPlayer.setDisable(false);
            this.playerCount = 5;
        ...
        p6 = new Button(" 6 ");
        p6.setOnAction((e -> {
            MyProject3 game = new MyProject3(6);
            this.players = game.getPlayers();
            disable();
            nextPlayer.setDisable(false);
            this.playerCount = 6;
        ...
        p7 = new Button(" 7 ");
        p7.setOnAction((e -> {
            MyProject3 game = new MyProject3(7);
            this.players = game.getPlayers();
            disable();
            nextPlayer.setDisable(false);
            this.playerCount = 7;
        ...
        p8 = new Button(" 8 ");
        p8.setOnAction((e -> {
            MyProject3 game = new MyProject3(8);
            this.players = game.getPlayers();
            disable();
            nextPlayer.setDisable(false);
            this.playerCount = 8;
